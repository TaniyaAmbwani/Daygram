...
SECRET_KEY = 'django-insecure-o^c=^-*@h#xff2lz+i#!^fzx*p(yuueqt9qpq3=#uxwd8_d@$#'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Static files for development
    BASE_DIR / "chatbot-folder/static",
]
...
LOGIN_URL = '/login/'  # Redirects to your custom login page
...
SESSION_ENGINE = 'django.contrib.sessions.backends.db'
SESSION_COOKIE_AGE = 60 * 60 * 24  # Set session age (24 hours)
